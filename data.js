...
app.post("/register", upload.array("files"), async (req, res) => {
    ...
    transporter.sendMail(mailOptions, (error, info) => {
        ...
        if (error) {
            ...
            let query = `INSERT INTO practice.userinfo (username, password, email, otp, filepath) VALUES ("${obj.username}","${obj.password}","${obj.email}","${otpToSend}","${obj.fileinfo}")`;
            // otpToSend = "";
